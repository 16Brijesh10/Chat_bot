...
from config import PDF_PATH,COMPANY_WEBSITE  # Ensure PDF_PATH and COMPANY_WEBSITE is a list of valid file paths
...
#def load_website_data():
    #"""Scrape and convert website data into document format."""
    #web_texts = scrape_company_website(COMPANY_WEBSITE)
    #website_documents = [Document(page_content=text, metadata={"source": "website"}) for text in web_texts]  #Convert to Document
